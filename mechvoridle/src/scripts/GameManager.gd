...
func equip_rifle_left_sword_right() -> void:
	...
	#owned_mech_components["LeftWeapon"] =  preload("uid://d0us0h3brlcaf")#arm rocket
	#owned_mech_components["LeftWeapon"] =  preload("uid://dyau5slcsx26u") #spear
	...
	#owned_mech_components["RightWeapon"] = preload("uid://dyau5slcsx26u") #spear
	#owned_mech_components["RightWeapon"] = preload("uid://bhfpkfpplvoco") #shoulder_rocket
